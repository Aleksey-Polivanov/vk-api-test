...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    public String sendMessages(String userID, String userName) throws IOException {
       ...
       String msg =
        ...
        String msg6 = "Привет, " +userName+ ", <br>" +
                "<br>" +
                "Мне показалось ты интересуешься JavaScript разработкой, поэтому решил " +
                "украсть немного твоего времени и рассказать о новом наборе курса " +
                "IT Climb React.js+Node.js.<br>" +
                "<br>" +
                "Ты изучишь как работу front-end, так и серверную часть приложений, Мы " +
                "много времени уделяем работе с базами данных, " +
                "с Git ты познакомишься на практике, когда твои коллеги по цеху " +
                "будут складывать изменения, из за которых " +
                "твой код перестанет работать) <br> Да, это особенность командной разработки, " +
                "но именно так и приобретаются знания. <br>" +
                "<br>" +
                "Мы не верим что можно стать боксёром без спаррингов, так же мы не верим что " +
                "можно стать программистом изучая лишь теорию. <br>" +
                "<br>" +
                "Наша группа: https://vk.com/itclimb <br>" +
                "<br>" +
//                "это мы https://www.youtube.com/watch?v=4zD7za2A_54 <br>" +
//                "<br>" +
//                "Так что если ты не можешь найти работу потому что у тебя нет работы, мы разорвем " +
//                "этот порочный круг. <br>" +
//                "<br>" +
                "Если ты смог дочитать это письмо до конца, вот номер телефона +380669241175 <br>" +
                "<br>" +
                "Звони, и мы расскажем тебе все подробности )";
                ...
                String msg4 = URLEncoder.encode(msg6,"UTF-8");
